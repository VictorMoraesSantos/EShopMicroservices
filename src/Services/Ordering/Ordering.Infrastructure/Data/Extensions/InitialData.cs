...
namespace Ordering.Infrastructure.Data.Extensions
{
    internal class InitialData
    {
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                Address address1 = Address.Of("mehmet", "ozkaya", "mehmet@gmail.com", "Bahcelievler No:4", "Turkey", "Istanbul", "38050");
                Address address2 = Address.Of("john", "doe", "john@gmail.com", "Broadway No:1", "England", "Nottingham", "08050");

                Payment payment1 = Payment.Of("mehmet", "5555555555554444", "12/28", "355", 1);
